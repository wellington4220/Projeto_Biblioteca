class Livros:
    def __init__(self,titulo,autor,paginas,status="ABC"):
        self.titulo = titulo
        self.autor = autor
...
lista_de_livros = [
    Livros("O Senhor dos Anéis", "J.R.R. Tolkien", 1200),
...
for livro in lista_de_livros:
    if livro.titulo == titulo_escolhido:
        ...
        livro.informacoes()  # Mostrando as informações atualizadas
        livro.registrar_usuário()
